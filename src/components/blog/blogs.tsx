...
const featuredPost_fake = {
  ...
  categories: [],
  comment_status: true,
  content: "\"<p class=\\\"mb-4 whitespace-pre-wrap\\\">Nếu bạn không muốn thay đổi backend hoặc cách trên không hiệu quả, bạn có thể xử lý chuỗi bị thoát ký tự ở frontend trước khi truyền vào BlogDetailContent.</p>\"",
  create_at: new Date(),
  description: "ádfdsf  dsaf",
  excerpt: null,
  feature_image: "uploads/images/1742485447208-39749abe214713612968d10f8be2c43b.jpg", 
  ping_status: true,
  post_status: "draft",
  slug: "df-sdf",
...
const BlogMain = (props: { categories: Category[]; posts: RawPost[] }) => {
  ...
  // const feature_post = getPostWithMostCategories(blogPosts);
  ...
  console.log('>>>feature post: ', getPostWithMostCategories(blogPosts));
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="relative h-60 md:h-auto">
                  <Image
                    src={`${process.env.NEXT_PUBLIC_BACKEND_URL}/${featuredPost.feature_image}` || ai6}
                    width={700}
                    height={500}
