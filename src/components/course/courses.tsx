        ...
        <div className="bg-gradient-to-b from-purple-900 to-indigo-800 text-white py-12">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto mb-8">
              Discover thousands of courses to help you grow your skills and advance your career
            </p>
        ...
        <div className="max-w-5xl container mx-auto px-4 py-8">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div
              ...
              } ${isFilterOpen ? "fixed inset-0 z-40 overflow-auto lg:static lg:z-0" : ""}`}
            >
              ...
              <Accordion
                type="multiple"
                defaultValue={["category", "instructor", "price", "rating", "level"]}
                className="space-y-4"
              >
                {/* Category Filter */}
                <AccordionItem value="category" className="border-b border-gray-200 dark:border-gray-700">
                  <AccordionTrigger className="text-base font-medium py-2">Course Category</AccordionTrigger>
                  <AccordionContent>
                ...
                {/* Instructor Filter */}
                <AccordionItem value="instructor" className="border-b border-gray-200 dark:border-gray-700">
                  <AccordionTrigger className="text-base font-medium py-2">Instructors</AccordionTrigger>
                  <AccordionContent>
                    <div className="space-y-2 pt-2">
                      {instructors.map((instructor) => (
                        <div key={instructor.id} className="flex items-center space-x-2">
                          ...
                          >
                            ...
                            <span className="text-gray-500 dark:text-gray-400 text-xs">({instructor.count})</span>
                          </label>
                        </div>
                      ))}
                    </div>
                ...
                {/* Rating Filter */}
                <AccordionItem value="rating" className="border-b border-gray-200 dark:border-gray-700">
                  <AccordionTrigger className="text-base font-medium py-2">Rating</AccordionTrigger>
                  <AccordionContent>
                    <RadioGroup
                      value={selectedRating?.toString() || ""}
                      onValueChange={(value) => setSelectedRating(Number.parseInt(value) || null)}
                    >
                      <div className="space-y-2 pt-2">
                        {[5, 4, 3, 2, 1].map((rating) => (
                          <div key={rating} className="flex items-center space-x-2">
                            ...
                            <label htmlFor={`rating-${rating}`} className="text-sm flex items-center cursor-pointer">
                              ...
                              <span className="ml-2">{rating === 5 ? "& up" : `& up`}</span>
                            </label>
                          </div>
                        ))}
                      </div>
                ...
                {/* Level Filter */}
                <AccordionItem value="level" className="border-b border-gray-200 dark:border-gray-700">
                  <AccordionTrigger className="text-base font-medium py-2">Level</AccordionTrigger>
                  <AccordionContent>
                        ...
                        {levels.map((level) => (
                          <div key={level.id} className="flex items-center space-x-2">
                            ...
                            >
                              ...
                              <span className="text-gray-500 dark:text-gray-400 text-xs">({level.count})</span>
                            </label>
                          </div>
                        ))}
                      </div>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  ...
                  {selectedLevel && (
                    <div className="bg-orange-100 dark:bg-orange-900 text-orange-800 dark:text-orange-200 rounded-full px-3 py-1 text-sm flex items-center">
                      <span>Level: {levels.find((l) => l.id === selectedLevel)?.name}</span>
                      <Button
                        variant="ghost"
                        size="icon"
                        className="h-5 w-5 ml-1 hover:bg-transparent"
